            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="#apps" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-object-group blue2_color"></i> <span>Commande</span></a>
                        <ul class="collapse list-unstyled" id="apps">
                           <li><a href="{{route('commandes.index')}}"> <span>Liste des Commandes</span></a></li>
                           <li><a href="{{route('commandes.create')}}"> <span>Ajouter Commande</span></a></li>
                        </ul>
                     </li>
                     <li class="active">
                        <a href="#additional_page" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-clone yellow_color"></i> <span>Livraison</span></a>
                        <ul class="collapse list-unstyled" id="additional_page">
                           <li>
                              <a href="{{route('livraisons.index')}}"> <span>Liste des Livraions</span></a>
                           </li>
                           <li>
                              <a href="{{route('livraisons.create')}}"> <span>Ajouter livraison</span></a>
                           </li>
                        </ul>
                     </li>
                     <!-- <li class="active">
                        <a href="#additional" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-clone yellow_color"></i> <span>Client</span></a>
                        <ul class="collapse list-unstyled" id="additional">
                           <li>
                              <a href="{{route('clients.index')}}"> <span>Liste des Clients</span></a>
                           </li>
                           <li>
                              <a href="{{route('client.formview')}}"> <span>Ajouter Clients</span></a>
                           </li>
                        </ul>
                     </li> -->
                  </ul>
